...
import com.schnell.safehome.GatewayFragment.OnDeviceActionTriggered
...
class DeviceRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.deviceName.text = if (item.additionalInfo != null) item.additionalInfo!!.displayName else item.name
        holder.deviceArm.isChecked = item.additionalInfo != null && item.additionalInfo!!.armState == true
